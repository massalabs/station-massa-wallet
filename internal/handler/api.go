...
func InitializeAPI(prompterApp prompt.WalletPrompterInterface, massaClient network.NodeFetcherInterface, accountsStore *assets.AccountsStore, gc gcache.Cache) (*operations.MassaWalletAPI, error) {
	...
	walletHandler.AppendEndpoints(api, prompterApp, massaClient, accountsStore, gc)
