...
func (e *envPrompter) PromptRequest(req PromptRequest) {
	...
	go func() {
		...
		switch req.Action {
		case walletapp.Sign:
			e.PromptApp.PromptInput <- &walletapp.SignPromptInput{BaseMessage: walletapp.BaseMessage{CorrelationID: ""}, Password: password, Fees: "500"}
		case walletapp.Delete, walletapp.NewPassword, walletapp.Unprotect:
			e.PromptApp.PromptInput <- &walletapp.StringPromptInput{BaseMessage: walletapp.BaseMessage{CorrelationID: ""}, Message: password}
		}
	}()
}
