...
func (m *Operation) validateCorrelationID(formats strfmt.Registry) error {
...
func (m *Operation) validateOperation(formats strfmt.Registry) error {
...
func (m *Operation) contextValidateCorrelationID(ctx context.Context, formats strfmt.Registry) error {
