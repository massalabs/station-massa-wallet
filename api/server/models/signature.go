...
func (m *Signature) validateCorrelationID(formats strfmt.Registry) error {
...
// ContextValidate validate this signature based on the context it is used
...
func (m *Signature) contextValidateCorrelationID(ctx context.Context, formats strfmt.Registry) error {
