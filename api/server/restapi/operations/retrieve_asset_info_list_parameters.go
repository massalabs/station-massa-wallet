...
// NewRetrieveAssetInfoListParams creates a new RetrieveAssetInfoListParams object
//
// There are no default values defined in the spec.
func NewRetrieveAssetInfoListParams() RetrieveAssetInfoListParams {

	return RetrieveAssetInfoListParams{}
}

// RetrieveAssetInfoListParams contains all the bound params for the retrieve asset info list operation
// typically these are obtained from a http.Request
//
// swagger:parameters RetrieveAssetInfoList
type RetrieveAssetInfoListParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewRetrieveAssetInfoListParams() beforehand.
func (o *RetrieveAssetInfoListParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *RetrieveAssetInfoListParams) bindAssetAddresses(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
