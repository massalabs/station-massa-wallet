...
func (o *SignURL) Build() (*url.URL, error) {
	...
	var _path = "/api/accounts/{nickname}/sign"
...
func (o *SignURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on SignURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on SignURL")
	}
