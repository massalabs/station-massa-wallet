...
func NewBackupAccountParams() BackupAccountParams {
	...
	return BackupAccountParams{}
}

// BackupAccountParams contains all the bound params for the backup account operation
...
func (o *BackupAccountParams) bindNickname(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
