...
func NewExportAccountFileParams() ExportAccountFileParams {
	...
	return ExportAccountFileParams{}
}

// ExportAccountFileParams contains all the bound params for the export account file operation
...
func (o *ExportAccountFileParams) bindNickname(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
