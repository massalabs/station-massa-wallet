...
func (o *ExportAccountFileURL) Build() (*url.URL, error) {
	...
	if nickname != "" {
		...
		return nil, errors.New("nickname is required on ExportAccountFileURL")
	}
...
func (o *ExportAccountFileURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ExportAccountFileURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ExportAccountFileURL")
	}
