...
// SignMessageParams contains all the bound params for the sign message operation
...
func (o *SignMessageParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.SignMessageRequest
...
func (o *SignMessageParams) bindNickname(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
