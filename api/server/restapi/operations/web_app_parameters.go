...
// NewWebAppParams creates a new WebAppParams object
...
// WebAppParams contains all the bound params for the web app operation
...
func (o *WebAppParams) bindResource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
