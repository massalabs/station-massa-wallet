...
func NewTransferCoinParams() TransferCoinParams {
	...
	return TransferCoinParams{}
}

// TransferCoinParams contains all the bound params for the transfer coin operation
...
func (o *TransferCoinParams) bindNickname(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
